...
/**
 * URL:http://www.daniweb.com/software-development/java/code/216874/primitive-
...
public class ByteConvertor
{
	...
	public static byte[] toByte(short[] data)
	{
		...
		for (int i = 0; i < data.length; i++)
			System.arraycopy(toByte(data[i]), 0, byts, i * 2, 2);
		return byts;
	}
	...
	public static byte[] toByte(int[] data)
	{
		...
		for (int i = 0; i < data.length; i++)
			System.arraycopy(toByte(data[i]), 0, byts, i * 4, 4);
		return byts;
	}
	...
	public static byte[] toByte(boolean[] data)
	{
		...
		// ----------
		int len = data.length;
		byte[] lena = toByte(len); // int conversion; length array = lena
	...
	public static byte[] toByte(String[] data)
	{
		...
		// ----- arrays:
		byte[] dLen = toByte(data.length); // byte array of data length
		...
		byte[] bsLens = toByte(sLens); // byte version of String sLens
